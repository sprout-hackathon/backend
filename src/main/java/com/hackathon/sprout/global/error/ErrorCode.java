...
public enum ErrorCode {
    ...
    INVALID_NATION_CODE(404, "INVALID_NATION_CODE", "유효하지 않은 국가 코드입니다."),
    INVALID_LANGUAGE_CODE(404, "INVALID_LANGUAGE_CODE", "유효하지 않은 언어 코드입니다."),
    INVALID_HOSPITAL_ID(404, "INVALID_HOSPITAL_ID", "유효하지 않은 병원 ID입니다."),
